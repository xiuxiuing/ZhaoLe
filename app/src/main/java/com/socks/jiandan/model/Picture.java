...
public class Picture implements Serializable {
    ...
    public static final String URL_BORING_PICTURE = "http://i.jandan.net/?oxwlxojflwblxbsapi=jandan.get_pic_comments&page=";
    public static final String URL_SISTER = "http://i.jandan.net/?oxwlxojflwblxbsapi=jandan.get_ooxx_comments&page=";
