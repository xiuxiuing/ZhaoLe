...
public class MainMenuFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        if (sp.getBoolean(SettingFragment.ENABLE_SISTER, false) && mAdapter.menuItems.size() == 3) {
            addAllMenuItems(mAdapter);
            mAdapter.notifyDataSetChanged();
        } else if (!sp.getBoolean(SettingFragment.ENABLE_SISTER, false) && mAdapter.menuItems.size() == 4) {
    ...
    private void addAllMenuItems(MenuAdapter mAdapter) {
        ...
        mAdapter.menuItems.add(new MenuItem("轶事", R.drawable.ic_explore_white_24dp, MenuItem.FragmentType.FreshNews, FreshNewsFragment.class));
        mAdapter.menuItems.add(new MenuItem("趣图", R.drawable.ic_mood_white_24dp, MenuItem.FragmentType.BoringPicture, PictureFragment.class));
        mAdapter.menuItems.add(new MenuItem("美女", R.drawable.ic_local_florist_white_24dp, MenuItem.FragmentType.Sister, SisterFragment.class));
        mAdapter.menuItems.add(new MenuItem("段子", R.drawable.ic_chat_white_24dp, MenuItem.FragmentType.Joke, JokeFragment.class));
        // mAdapter.menuItems.add(new MenuItem("小电影", R.drawable.ic_movie_white_24dp,
        // MenuItem.FragmentType.Video,
        // VideoFragment.class));
    }
